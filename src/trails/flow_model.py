...
import snkit.network as network
...
from snkit.simplify import *
from snkit.extract import railway,ferries,mainRoads,roads
...
def country_run(country,plot=False,save=True):
    """[summary]
...
if __name__ == '__main__':
    country_run(sys.argv[1],plot=True)